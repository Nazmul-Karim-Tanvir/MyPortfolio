...
<!-- Contact section -->
    ...
    <section id="contact" class="py-5">
        <div class="container">
            ...
            <form class="contact-form form-bg-editing rounded" action="https://formspree.io/f/mldrdjyp" method="post">

                <div class="form-group">
                    <label for="countryname"><i>Country/Region:</i></label>
                    <input type="text" class="form-control" id="countryname" name="countryname" placeholder="Enter your country/region" required>
                </div>
                ...
                <div class="form-group">
                    <label for="text"><i>Message:</i></label>
                    <textarea class="form-control" id="text" name="text" rows="5" placeholder="Enter some text" required></textarea>
                </div>
            
                <div class="form-group">
                    <label for="number">Contact Number: </label>
                    <input type="tel" class="form-control" id="number" name="number" placeholder="Enter your number (Optional)">
                </div>
